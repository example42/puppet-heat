# Define heat::generic_service
#
# This class implements basic ceilomer services.
# It is derived from https://github.com/stackforge/puppet-heat/blob/master/manifests/generic_service.pp
#
define heat::generic_service (
